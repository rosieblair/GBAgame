...
#define HEIGHT 160  // = # rows
#define AREA 38400  // = 240 * 160
...
//                       LOGIC & OTHER STUFF
// ---------------------------------------------------------------------------
#define ITEM_ROW_RAND 100
#define ITEM_COL_RAND 180

#define MELON_COUNT_X 5
#define MELON_COUNT_Y 5
#define MELON_ROW_RAND 115
#define MELON_COL_RAND 195

#define POS_EDGE_MIN 30
#define POS_EDGE_X 100
#define POS_EDGE_Y 180

// Item struct, game object
typedef struct {
	int x;
	int y;
	int dx;
